...
<template>
  <footer
    class="max-w-[69.25rem] mx-auto flex flex-col md:flex-row px-8 lg:px-0 py-6 text-licorice font-light justify-between w-full gap-y-6"
  >
    <p class="max-w-[11.4375rem] 2xl:max-w-[23.75rem] w-full gap-y-6">
